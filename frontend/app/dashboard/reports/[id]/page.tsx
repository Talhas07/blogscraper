        ...
        <CardContent className="pt-6">
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-700 mt-4">
                To enhance your security posture, we recommend addressing the
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="px-2 py-1">
                        Immediate action required. Risks pose severe threats to
                        organizational security, potentially leading to
                        significant data breaches or system compromise. Full
                        implementation of recommended Essential Eight controls
                    ...
                    <tr>
                      ...
                      <td className="px-2 py-1">
                        Prompt attention needed. Risks could result in
                        substantial impact, such as unauthorized access or
                        operational disruption. Prioritize strengthening
                        relevant Essential Eight controls to reduce exposure.
                      </td>
                    </tr>
                    <tr>
                      <td className="px-2 py-1 text-yellow-700 md:w-48">
                        Moderate (26-50)
                      </td>
                      <td className="px-2 py-1">
                        Manageable but not negligible. Risks may cause limited
                        impact or partial compromise. Implement or enhance
                        Essential Eight controls as part of regular security
                        improvements to address vulnerabilities.
                      </td>
                    </tr>
                    <tr>
                      <td className="px-2 py-1 text-green-700">Low (0-25)</td>
                      <td className="px-2 py-1">
                        Minimal immediate concern. Risks have low likelihood or
                        impact but should be monitored. Ensure Essential Eight
                        controls remain effective to prevent escalation over
                        time.
                      </td>
                    </tr>
                  </tbody>
              ...
              <br></br>
              <p className="text-gray-700 mt-4">
                By addressing these strategies in this order, we can effectively
                prioritise resources to mitigate the most critical and high-risk
                vulnerabilities first, followed by moderate risks.
              </p>
              <br></br>
              <h2 className="text-2xl font-semibold mb-4 text-blue-800">
                Conclusion:
              ...
              <p className="text-gray-700 mt-4">
                The comprehensive gap analysis conducted for{" "}
                {reportData?.assessment.clientName} has delivered a detailed and
                actionable assessment of the organisation's current
                cybersecurity posture, benchmarked against the Australian Cyber
                Security Centre’s Essential Eight maturity model. This rigorous
                evaluation has illuminated critical areas where{" "}
                {reportData?.assessment.clientName} existing security measures
                align with best practices, as well as key deficiencies that
                require strategic attention to achieve compliance and bolster
                overall resilience.
              </p>
              <p className="text-gray-700 mt-4">
                By systematically addressing the identified gaps—ranging from
                incomplete implementation of mitigation strategies to areas
                requiring enhanced controls—the organisation can significantly
                strengthen its defences against evolving cyber threats. The
                recommendations outlined in this report are tailored to{" "}
                {reportData?.assessment.clientName} unique operational context
                and risk profile, ensuring that proposed measures are both
                practical and effective
              </p>
              <p className="text-gray-700 mt-4">
                Implementing these recommendations will enable{" "}
                {reportData?.assessment.clientName} to elevate its security
                posture to meet or exceed the Essential Eight maturity level
                appropriate for its risk environment. This proactive approach
                will not only mitigate vulnerabilities but also safeguard the
                organisation’s critical information assets, intellectual
                property, and sensitive data. Furthermore, achieving a higher
                level of cybersecurity maturity will enhance stakeholder
                confidence, support regulatory compliance, and position as a
                leader in cybersecurity resilience within its sector.
              </p>
              <p className="text-gray-700 mt-4">
                To maximise the impact of these efforts, we recommend that{" "}
                {reportData?.assessment.clientName} prioritise the remediation
                ...
                sustained progress. By committing to these strategic
                improvements, {reportData?.assessment.clientName} will be
                well-equipped to navigate the complex threat landscape and
                protect its operational integrity for the long term.
              </p>
            </div>
          </div>
        </CardContent>
